...
public class AccountCreationLocators {
    ...
    public By secureYourAccountText = By.xpath("//div[@class='styles__Text-sc-1f8sacp-0 cQkuYH']");
    public By enterPersonalDetailsText = By.xpath("//div[@class='styles__Text-sc-1f8sacp-0 cQkuYH']");
    public By createPasswordInputField = By.xpath("//input[@id='id_password']");
    ...
    public By completeButton = By.xpath("//button[@class='styles__Button-sc-1bmw993-0 iNrErr']");
