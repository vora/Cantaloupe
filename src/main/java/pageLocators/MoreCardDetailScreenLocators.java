...
public class MoreCardDetailScreenLocators extends TestBase {
    ...
    public By activeText = By.xpath("//*[contains(text(),'Active')]");
    ...
    public By manualReloadText = By.xpath("//*[contains(text(),'Manually Reload')]");
    ...
    // String  balanceAmount = "//*[contains(text(),'"+addedMoreCardLast4Numbers+"')]//preceding::div[1]";

    public By balanceAmountWithDigits(String addedMoreCardLast4Numbers) {
        String lastFourDigits = "//*[contains(text(),'" + addedMoreCardLast4Numbers + "')]//preceding::div[1]";
        return By.xpath(lastFourDigits);
    }
}
