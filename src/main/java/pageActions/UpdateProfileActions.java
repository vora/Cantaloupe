...
public class UpdateProfileActions extends TestBase {
    ...
    public void updateDetailsFields(String firstName, String lastName, String mobile, String streetAddress, String city, String state, String zipcode) throws AWTException, IOException {
    ...
    public String updateFirstName(String firstName) throws AWTException {
        WebElement firstNameInput = driver.findElement(updateProfileLocators.firstNameInput);
         String firstname = baseActions.regexFirstAndLastName(updateProfileLocators.firstNameInput, firstName);
    ...
    public String updateLastName(String LastName) {
        ...
        String lastName = baseActions.regexFirstAndLastName(updateProfileLocators.lastNameInput, LastName);
        lastNameInput.click();
    ...
    public String updateMobile(String mobile) throws IOException, AWTException {
        WebElement mobileInput = driver.findElement(updateProfileLocators.mobileInput);
        String mobileNumber = baseActions.regexPhoneno(updateProfileLocators.mobileInput, mobile);
        mobileInput.click();
    ...
    public String updateStreetAddress(String streetAddress) {
        WebElement streetAddressInput = driver.findElement(updateProfileLocators.streetAddressInput);
        String streetAddressValue = baseActions.regexPhoneno(updateProfileLocators.streetAddressInput, streetAddress);
        streetAddressInput.click();
        streetAddressInput.sendKeys(streetAddressValue);
        return streetAddressValue;
    }

    //Verify if user is able to edit and enter new value in the street fields
    public String updateCity(String city) {
        WebElement cityInput = driver.findElement(updateProfileLocators.cityInput);
        String cityValue = baseActions.regexPhoneno(updateProfileLocators.cityInput, city);
        cityInput.click();
    ...
    public String updateState(String enterState) {
        ...
        boolean state = baseActions.regexState(updateProfileLocators.stateInput, enterState);
        if(state==true)
        {
            stateInput.click();
            baseActions.clearInputfieldAndEnterNewData(updateProfileLocators.stateInput, enterState);
    ...
    public String  updateZipcode(String zipcode) {
        ...
        String zipcodeValue = baseActions.regexZipcode(updateProfileLocators.zipcodeInput, zipcode);
        zipcodeInput.click();
        return zipcodeValue;
    }
    ...
    public void verifyUpdateProfileFunctionality(String firstName, String lastName, String mobile, String streetAddress, String city, String state, String zipcode) throws AWTException, IOException {
        String firstname = updateFirstName(firstName);
        String lastname = updateLastName(lastName);
        String mobileNumber = updateMobile(mobile);
        String streetAddressUpdateValue = updateStreetAddress(streetAddress);
        String cityUpdateValue = updateCity(city);
        String stateupdateValue = updateState(state);
        String zipcodeUpdateValue = updateZipcode(zipcode);
        ...
        Assert.assertEquals(streetAddressValue, streetAddressUpdateValue, "Street Address is equal");
        Assert.assertEquals(cityValue, cityUpdateValue, "City is equal");
        Assert.assertEquals(stateValue, stateupdateValue, "State is equal");
        Assert.assertEquals(zipcodeValue, zipcodeUpdateValue, "Zipcode is equal");
    }
    ...
    public void verifyMobileUniquesNessTick() throws IOException, AWTException {
        baseActions.randomClickBasedOnOS();
        Boolean checkTickMark = baseActions.verrifyTickMark(updateProfileLocators.tickMarkImageForMobile);
    ...
    //Verify if fields are in editable mode
    public void verifyFieldsAreEditable()
    {
        //baseActions.checkFieldsAreEditable(updateProfileLocators.passwordFieldMasked);
        baseActions.checkFieldsAreEditable(updateProfileLocators.firstNameInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.lastNameInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.mobileInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.streetAddressInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.cityInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.stateInput);
        baseActions.checkFieldsAreEditable(updateProfileLocators.zipcodeInput);
    }
