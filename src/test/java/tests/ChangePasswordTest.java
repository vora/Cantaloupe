...
public class ChangePasswordTest extends TestBase {
   ...
   @Test
    ...
    @Test
    //Verify if the both password fields matches and validate for regex
    public void verifyOldPassowrd_UpdateDisabled() throws IOException, AWTException {
        signInWithExistingAccountActions.clickAlreadyExistingAccountLink();
        signInWithExistingAccountActions.clickSignIn(properties.getProperty("existingAccountEmail"), properties.getProperty("existingAccountPassword"));
        signInWithExistingAccountActions.clickProfileLink();
        changePasswordActions.clickChangeButton();
        changePasswordActions.verifyPasswordMatches("Mason@123", "Mason@123");
        changePasswordActions.verifyOldPassowrd_Updatedisable();
    }

    @Test
    //Verify if the both password fields matches and validate for regex
    public void verifyOldPassowrd_UpdateEnabled() throws IOException, AWTException {
        signInWithExistingAccountActions.clickAlreadyExistingAccountLink();
        signInWithExistingAccountActions.clickSignIn(properties.getProperty("existingAccountEmail"), properties.getProperty("existingAccountPassword"));
        signInWithExistingAccountActions.clickProfileLink();
        changePasswordActions.clickChangeButton();
        changePasswordActions.verifyPasswordMatches("Mason@123", "Mason@123");
        changePasswordActions.verifyOldPassowrd_UpdateEnabled(properties.getProperty("oldPassword"));
    }

    @Test
    //Verify if the both password fields matches and validate for regex
    public void updatePasswordFunctionality() throws IOException, AWTException {
        signInWithExistingAccountActions.clickAlreadyExistingAccountLink();
        signInWithExistingAccountActions.clickSignIn(properties.getProperty("existingAccountEmail"), properties.getProperty("existingAccountPassword"));
        signInWithExistingAccountActions.clickProfileLink();
        changePasswordActions.clickChangeButton();
        changePasswordActions.verifyPasswordMatches("Mason@123", "Mason@123");
        changePasswordActions.verifyOldPassowrd_UpdateEnabled(properties.getProperty("oldPassword"));
        changePasswordActions.clickUpdateButton();
    }

    @Test
    //Verify if the both password fields matches and validate for regex
    public void loginwithNewPassword() throws IOException, AWTException {
        signInWithExistingAccountActions.clickAlreadyExistingAccountLink();
        signInWithExistingAccountActions.clickSignIn(properties.getProperty("existingAccountEmail"), properties.getProperty("existingAccountPassword"));
        signInWithExistingAccountActions.clickProfileLink();
        changePasswordActions.clickChangeButton();
        ...
        signInWithExistingAccountActions.clickSignIn(properties.getProperty("existingAccountEmail"), properties.getProperty("newPassword"));
    }
